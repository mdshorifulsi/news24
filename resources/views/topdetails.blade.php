						...
						<div class="col-lg-8 post-list">
							...
							<div class="single-post-wrap">
								<div class="content-wrap">
									...
									<a href="#">
										<h3>{{ $topdetails->title }}</h3>
									</a>
									<ul class="meta pb-20">
										<li><a href="#"><span class="lnr lnr-user"></span>{{$topdetails->user->name}}</a></li>
										<li><a href="#"><span class="lnr lnr-calendar-full"></span>{{$topdetails->created_at->toFormattedDateString()}}</a></li>
										{{-- <li><a href="#"><span class="lnr lnr-bubble"></span>06 </a></li> --}}
									</ul>
									<P><img src="{{ asset($topdetails->image)}}"style="width:650px;height:300px;"></P>
